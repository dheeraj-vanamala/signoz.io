...
- Check if Dashboards and Alert conditions for references to this metric label.
...
2. Wait 1 hour, then check the **Cost Meter Dashboard** and confirm the `datapoint.count` trend has dropped.
